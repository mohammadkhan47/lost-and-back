// lib/views/lost_items/report_lost_item_screen.dart
...
class _ReportLostItemScreenState extends State<ReportLostItemScreen> {
  ...
  Future<void> _submitReport() async {
    ...
    final viewModel = context.read<LostItemViewModel>();

    final success = await viewModel.reportLostItem(
      ...
      rewardPoints: _rewardController.text.isEmpty
          ? null
          : int.tryParse(_rewardController.text),
    );
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // Location
                  _buildSectionTitle('Lost Location'),
                  const SizedBox(height: 12),
                  _buildLocationField(),
                  const SizedBox(height: 20),
                  ...
                  // Reward (Optional)
                  _buildSectionTitle('Reward Points (Optional)'),
                  const SizedBox(height: 12),
                  _buildTextField(
